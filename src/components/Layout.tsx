    ...
    <div className="min-h-screen bg-[#f5f4f0]" style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#E5E5E5] z-50 md:top-0 md:bottom-auto md:border-b md:border-t-0 px-4 py-2 flex justify-between items-center">
        ...
        <div className="flex gap-6 md:gap-8 overflow-x-auto no-scrollbar">
          ...
          >
            <Home size={20} />
            <span className="text-[10px] md:text-sm uppercase tracking-wider">Home</span>
          </Link>
          <Link
            to="/assessment"
          ...
          >
            ...
            <span className="text-[10px] md:text-sm uppercase tracking-wider">Assessment</span>
          </Link>
          ...
          {isAdmin && (
            <>
              ...
              >
                ...
                <span className="text-[10px] md:text-sm uppercase tracking-wider">Results</span>
              </Link>
              <Link
                to="/calendar"
              ...
              >
                ...
                <span className="text-[10px] md:text-sm uppercase tracking-wider">Calendar</span>
              </Link>
            </>
          )}
        </div>
